        ...
        <div key={i} className={clsx(className, 'relative')}>
          <Skeleton className="h-full w-full rounded-xl">
            ...
            <div className="flex flex-col justify-end gap-1.5 p-3 ">
              <Skeleton className="h-10.75 w-full rounded-lg bg-primary" />
              <Skeleton className="h-6 w-20 rounded-lg bg-primary" />
              <Skeleton className="h-[35.5px] rounded-lg bg-primary mt-1" />
            </div>
          </Skeleton>
        </div>
      ))}
