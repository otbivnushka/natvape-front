  ...
  return (
    <div className={clsx('mb-6', className)}>
      ...
      <div className="flex justify-center gap-4 flex-wrap">
        <PrimaryButton className="bg-surface text-primary" selected={time === 'soon'} onClick={() => setTime('soon')}>
          Как можно скорее
        </PrimaryButton>
        <h2 className="text-sm font-semibold text-primary">ИЛИ</h2>
        <PrimaryButton className="bg-surface text-primary" selected={time === 'whenever'} onClick={() => setTime('whenever')}>
          Не важно когда
        </PrimaryButton>
      </div>
    </div>
