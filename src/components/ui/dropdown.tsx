...
const Dropdown = <T extends string>({
  ...
  return (
    <div ref={ref} className={clsx('relative inline-flex', className)}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-1 z-50 min-w-full w-max bg-surface border-2 border-line rounded-xl overflow-auto max-h-75 animate-[scaleIn_0.12s_ease]">
          {options.length === 0 ? (
